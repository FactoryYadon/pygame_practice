...
# 배경 이미지 불러오기
background = pygame.image.load("D:\\1.프로젝트\\잡동사니\\python\\pygame\\pygame_basic\\background.png")

# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("D:\\1.프로젝트\\잡동사니\\python\\pygame\\pygame_basic\\character.png")
